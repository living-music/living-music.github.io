...
export type IconName="home"|"browse"|"search"|"heart"|"play"|"pause"|"previous"|"next"|"previousDesktop"|"nextDesktop"|"queue"|"close"|"chevron"|"music"|"back"|"more"|"up"|"down"|"repeat"|"trash"|"video"|"add"|"check"|"shuffle"|"download"|"settings";
...
browse:<><rect x="2.5" y="2.5" width="8.5" height="8.5" rx="2.2" fill="currentColor" stroke="none"/><rect x="13" y="2.5" width="8.5" height="8.5" rx="2.2" fill="currentColor" stroke="none"/><rect x="2.5" y="13" width="8.5" height="8.5" rx="2.2" fill="currentColor" stroke="none"/><rect x="13" y="13" width="8.5" height="8.5" rx="2.2" fill="currentColor" stroke="none"/></>,
...
previous:<g transform="translate(24 0) scale(-1 1)"><path d="M3.2 6.15c0-.94 1.06-1.5 1.83-.96l7.37 5.11a2.08 2.08 0 0 1 0 3.4l-7.37 5.11c-.77.54-1.83-.02-1.83-.96Z" fill="currentColor" stroke="none"/><path d="M10.6 6.15c0-.94 1.06-1.5 1.83-.96l7.37 5.11a2.08 2.08 0 0 1 0 3.4l-7.37 5.11c-.77.54-1.83-.02-1.83-.96Z" fill="currentColor" stroke="none"/></g>,next:<><path d="M3.2 6.15c0-.94 1.06-1.5 1.83-.96l7.37 5.11a2.08 2.08 0 0 1 0 3.4l-7.37 5.11c-.77.54-1.83-.02-1.83-.96Z" fill="currentColor" stroke="none"/><path d="M10.6 6.15c0-.94 1.06-1.5 1.83-.96l7.37 5.11a2.08 2.08 0 0 1 0 3.4l-7.37 5.11c-.77.54-1.83-.02-1.83-.96Z" fill="currentColor" stroke="none"/></>,
previousDesktop:<g transform="translate(24 0) scale(-1 1)"><path d="M1.5 6.1c0-.68.75-1.08 1.32-.7l9 5.28a1.52 1.52 0 0 1 0 2.64l-9 5.28c-.57.38-1.32-.02-1.32-.7Z" fill="currentColor" stroke="none"/><path d="M10.2 6.1c0-.68.75-1.08 1.32-.7l9 5.28a1.52 1.52 0 0 1 0 2.64l-9 5.28c-.57.38-1.32-.02-1.32-.7Z" fill="currentColor" stroke="none"/></g>,nextDesktop:<><path d="M1.5 6.1c0-.68.75-1.08 1.32-.7l9 5.28a1.52 1.52 0 0 1 0 2.64l-9 5.28c-.57.38-1.32-.02-1.32-.7Z" fill="currentColor" stroke="none"/><path d="M10.2 6.1c0-.68.75-1.08 1.32-.7l9 5.28a1.52 1.52 0 0 1 0 2.64l-9 5.28c-.57.38-1.32-.02-1.32-.7Z" fill="currentColor" stroke="none"/></>,
